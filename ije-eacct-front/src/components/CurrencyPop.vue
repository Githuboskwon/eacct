    ...
    <div slot="content">
      ...
      <div class="pop-content-search">
          <div class="field has-addons ">
              <div class="mr20 ">
                  <span class="pop-c-name">-통화 코드/명</span>
              </div>
...
export default {
  ...
  data() {
    return {
      columnDefs : [
        ...
        {headerName: '통화코드', field: 'currencyCode', width: 160, cellStyle:{textAlign: 'left'}},
        {headerName: '통화명', field: 'currencyName', width: 180, cellStyle:{textAlign: 'left'}},
        {headerName: '', field: 'precision', width: 180, cellStyle:{textAlign: 'left'}},
        {headerName: '', field: 'extendedPrecision', width: 288, cellStyle:{textAlign: 'left'}},
        {headerName: '', field: 'startDateActive', width: 288, cellStyle:{textAlign: 'left'}},
        {headerName: '', field: 'endDateActive', width: 288, cellStyle:{textAlign: 'left'}},
        {headerName: '', field: 'enabledFlag', width: 288, cellStyle:{textAlign: 'left'}},
      ],
      gridOptions : {},
      defaultColDef: { 
        resizable: true, 
  ...
  methods: {
    goSearch() {
      ...
      this.$http.post(`/api/currency/list`, {
        currencyName: this.search,
      })
        .then((result) => {
