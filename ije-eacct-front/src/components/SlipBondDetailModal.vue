                ...
                <table class="table">
                  <tbody>
                    <tr>
                      ...
                      <th style="width: 140px;">만기일자</th>
                      <td colspan="3">{{getDateFormat(data.futurePayDueDt)}}</td>
                    </tr>
                    <tr>
                      <th>작성자</th>
            ...
            <div class="content">
              <div class="btn-wrap" >
                ...
                <table class="table">
                  ...
                  <tr>
                    <th>계정과목</th>
                    <td colspan="3">{{data.segment4Desc}}</td>
                    <th>만기금액</th>
                    <td colspan="3">{{getNumberFormat(data.sumAmt)}}</td>
                  </tr>
                  </tbody>
                </table>
                ...
                <div class="table-b">
                  <div class="grid-wrap">
                    <ag-grid-vue ref="grid" style="width: 100%; height:500px;" class="ag-theme-alpine grid_search_height_350"
                                rowSelection="single" 
...
export default {
  ...
  methods: {
    ...
    makeSumData(){
      ...
      let sum = [{
        rn: 'TOTAL',
        baseAmt: this.data.dtList.reduce((prev, next) => {return Number(prev) + Number(next.baseAmt)}, initValue)
      }]
    ...
    approval() {
      ...
      let docTitleNm = that.isEmpty(that.data.remark) === "" ? that.data.sumAmt : that.isEmpty(that.data.remark) + ' / ' + that.data.sumAmt;
