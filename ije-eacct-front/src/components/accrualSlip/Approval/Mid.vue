<template>
    <div class="table-area">
        <div class="table-a fixed-th">
            ...
            <div class="table-name">
                <h3 class="ico_table_name" style="float:left;">공급자 & 결제조건</h3>
                <div class="btn-wrap btn-type1 clearfix" style="float:right;">
                    <el-button size="midium" type="success" @click="searchPrepayment" icon="el-icon-search" v-if="value.prepaymentApplyFlag == 'K'">선급금 반제 조회</el-button>
                </div>
            </div>
            <table class="table">
                <tbody>
 ...
 * * 보조 컴포넌트
 */
import AssistantVAT from '@/components/accrualSlip/Assistant/AssistantVAT.vue';
import AdvancedModal from "@/components/accrualSlip/Modals/AdvancedModal"; /** 부가세 */
