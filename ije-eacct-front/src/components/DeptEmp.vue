    ...
    <div slot="content">
      ...
      <div class="pop-content-search">
          <div class="field has-addons ">
              <div class="mr20 ">
                  <span class="pop-c-name">- 임직원 사번/성명</span>
              </div>
...
export default {
  ...
  data() {
    return {
      columnDefs : [
        ...
        {headerName: '호칭', field: 'jobGradeNm', width: 180, cellStyle:{textAlign: 'left'}},
  ...
  methods: {
    goSearch() {
      ...
      this.$http.post(`/api/emp/pop/dept/list/`,param)
      .then((result) => {
  ...
  created() {
    ...
    if(this.type !== undefined) this.deptCd = this.type;
