            ...
            <div class="pop-content-search">
                <div class="field has-addons">
                  ...
                  <div class="control is-expanded search-area">
                    ...
                    <div class="control is-expanded search-area">
                        <div class="rs-mt2">
                            <span class="NotoM" style="margin-right: 10px;">- 제품군코드</span>
                            <el-input type="text" v-model="search.code" @keypress.native.enter="goSearch" clearable style="width: 60%;">
                                <i class="el-icon-search el-input__icon" slot="suffix" @click="goSearch"></i>
                            </el-input>
                        </div>
                    </div>
...
export default {
  compatConfig: { MODE: 2 },
    ...
    created() {
        this.search.code = this.schTxt || '';
        this.search.name = this.taskItemGroup || '';
    ...
    methods: {
        goSearch() {
            ...
            this.$http.post(`/api/cost/budget/pop/item/list`, params)
            .then(res => res.data)
            .then(data => {
                this.rowData = data;
            })
