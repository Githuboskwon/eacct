...
export default {
  ...
  data() {
    return {
      columnDefs : [
        ...
        {headerName: '프로젝트명', field: 'name', width: 120, cellStyle:{textAlign: 'left'}},
        {headerName: '타입', field: 'projectType', width: 180, cellStyle:{textAlign: 'left'}},
        {headerName: '상태', field: 'projectStatusCode', width: 288, cellStyle:{textAlign: 'left'}},
      ],
      gridOptions : {},
      defaultColDef: {
        resizable: true,
  ...
  methods: {
    goSearch() {
      ...
      this.$http.post(`/api/bond/project`, {
        search : this.search,
      })
      .then((result) => {
