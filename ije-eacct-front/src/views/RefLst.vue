            ...
            <div class="item search_wrap">
                <div class="search_box">
                    <div class="search_title">
                        <span class="search_tit" style="color: #CC3D3D;">- 기안일자</span>
                    </div>
...
<!--                            </div>-->
                            ...
                            <div class="search_box_pop">
                                <div class="search_title">
                                    <span class="search_tit">- 참조자</span>
                                </div>
                                <div class="search_con search-area">
            ...
            <div class="table-b">
                <div class="table-header">
                    <div class="table-name">
                        <h3 class="ico_table_name">참조된 문서</h3>
                    </div>
                    <div class="btn-type1 clearfix">
...
import DraftPop from "@/components/costBudget/DraftPop.vue";
...
export default {
    ...
    methods: {
        rowDoubleClick(params){
            ...
            let slipHeaderId = params.data.slipHeaderId;
        ...
        showDetailPop(slipNo, slipType, docMngNo, params){
            ...
            if(_.isEmpty(params.data.wrtId)){
                params.data.wrtId = params.data.draftId
            }
            switch(slipType)
            {
              case '21' :
        ...
        goSearch() {
            ...
            this.$http.post(`/api/appr/ref/list`, {
        ...
        resetSearch(){
            ...
            this.form.draftId = this.$store.state.loginInfo.loginId;
        ...
        makeColDef(){
            ...
            this.columnDefs = [
                ...
                // },
                {
                    ...
                    /*valueFormatter: (params) => {
                      if(params.value === '제목'){
                        return params.data.headerRemark
                      }
                    },*/
                    cellStyle:{textAlign: 'left'}
                },
    ...
    created(){
        if(!_.isEmpty(this.$route.query)){
            this.form.slipStatus = this.$route.query.slipStatus
        }
    ...
    mounted() {
        ...
        this.form.draftId = this.$store.state.loginInfo.loginId;
        this.form.draftNm = this.$store.state.loginInfo.userName;
        this.form.draftUserDut = this.$store.state.loginInfo.loginJobGradeNm;
        this.form.draftUserDept = this.$store.state.loginInfo.loginDeptNm;
