            ...
            <div class="search_box_pop">
              ...
              <div class="search_con search-area">
                <div class="datepicker w-type-ymd02 w45p">
                  <dhx-calendar class="input ddate sDate" v-model="form.openingDtFrom" :config="config"/>
                </div>
                <span class="datepicker w10p dp-ib tac"> ~ </span>
                <div class="datepicker w-type-ymd02 w45p">
                  <dhx-calendar class="input ddate sDate" v-model="form.openingDtTo" :config="config"/>
                </div>
              </div>
            </div>
      ...
      <div class="table-b">
        <div class="table-header">
          <div class="table-name">
            <h3 class="ico_table_name">PJT 실행예산기안 내역</h3>
          </div>
  ...
  methods: {
    ...
    createColumnDefs(){
      ...
      this.columnDefs = [
        ...
        {headerName: 'PJT 종료일', field: 'endDt', width: 150},
        ...
        {headerName: '작성자', field: 'intergrationVendorNum', width: 150, headerClass: 'require-column',},
        {
          headerName: '예산부서',
          field: 'CctrAg',
          width: 200,
        ...
        {headerName: '전표헤더ID', field: 'intergrationVendorNum', width: 150},
