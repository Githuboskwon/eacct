...
<!--                  </div>-->
            ...
            <div class="search_box_pop">
              ...
              <div class="search_con search-area">
                ...
                <div class="dp-ib w70p">
                  <input class="input" type="text" v-model="form.transferredByNm" @input="initTransfferedBy(true)" @keypress.enter="popTransfferedBy">
            ...
            <div class="search_box_pop">
              <div class="search_title">
                <span class="search_tit">공급자명</span>
              </div>
              <div class="search_con search-area">
                <input class="input input-bg w30p_5r" type="text" v-model="form.vendorId" disabled>
                <div class="dp-ib w70p">
                  <input class="input" type="text" v-model="form.vendorNm" @input="initVendor(true)" @keypress.enter="popVendor">
            ...
            <div class="search_box_pop">
              ...
              <div class="search_con search-area">
                ...
                <div class="dp-ib w70p">
                  <input class="input" type="text" v-model="form.bankAcctNm" @input="initBankAcctNm(true)" @keypress.enter="popBankAcctNm">
            ...
            <div class="search_box_pop">
              <div class="search_title">
                <span class="search_tit">지급문서번호</span>
              </div>
              <div class="search_con search-area">
                <input class="input" type="text" v-model="form.checkNo" >
              </div>
            </div>
            <div class="search_box_pop">
              <div class="search_title">
                <span class="search_tit">만기일</span>
              </div>
              <div class="search_con search-area">
                <div class="form-input">
      ...
      <div class="table-b">
        <div class="table-header">
          <div class="table-name">
            <h3 class="ico_table_name">건별지급내역</h3>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        slipType: '21',
        searchFrom: this.$moment().startOf('year').format('YYYY-MM-DD HH:mm:ss'),
  ...
  methods: {
    ...
    goSearch(){
      ...
      this.form.futurePayDueDt =  this.form.futurePayDueDt ? this.$moment(this.form.futurePayDueDt).format("YYYY-MM-DD HH:mm:ss") : '';

      this.$store.commit('loading')
      this.$http.post('/api/erp/slip/item/list', this.form)
          .then(response => {
    ...
    pull() {
      ...
      this.form.searchFrom = this.$moment(this.searchDt[0]).format("YYYY-MM-DD HH:mm:ss");
      this.form.searchTo = this.$moment(this.searchDt[1]).format("YYYY-MM-DD HH:mm:ss");
      this.$http.post('/api/erp/slip/21', this.form)
          .then((res) => {
      ...
      if(list.length > 0){
        this.$swal({
          ...
          if (r.value) {
            this.$store.commit('loading')
            vm.result = list;
            this.$http.post(`/api/erp/slip/delete/21`, vm.result)
                .then((response) => {
