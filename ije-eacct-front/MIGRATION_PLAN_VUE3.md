...
- **TODO(다음 증분):** `config_E1`+`config_E1_2`(법인카드 2그리드: 카드정보·스캔증빙 팝업)
...
7. [~] **(진행 2026-06-16)** A그룹 진행 — `GridRO` 전환 완료(§8.9) / `GridED` 본전환 진행: `GridED_Ag.vue` **증분1=def, 증분2=E6, 증분3=E2/E5 완성**(§8.10). 다음 증분: E1(법인카드 2그리드), 이후 `slip-basic.js` 연결 + 슬립유형별 런타임 검증 → `SlipGr`/`SlipCrdLstModal`/`BdgReq` 등
