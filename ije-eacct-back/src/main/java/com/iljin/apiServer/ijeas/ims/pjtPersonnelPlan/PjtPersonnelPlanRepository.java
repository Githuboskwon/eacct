...
public interface PjtPersonnelPlanRepository extends JpaRepository<PjtPersonnelPlan, PjtPersonnelPlanKey> {

    @Modifying
    @Query(" UPDATE PjtPersonnelPlan A SET " +
            "   A.orgId = :compCd " +
            ...
            " AND A.yyyyMm = :yyyymm")
    void updatePjtPersonnelPlan(@Param("compCd") String compCd,
