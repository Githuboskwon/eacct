...
import com.iljin.apiServer.ijeas.ims.pjtProcessRatePlan.PjtProcessRatePlanDto;
...
@Data
@NoArgsConstructor
public class PjtPersonnelPlanDto implements Serializable {
    ...
    @QueryProjection
    public PjtPersonnelPlanDto(String orgId, String projectId, String projectCode, String projectName, String taskId, String taskNumber, String taskName,
    ...
    public PjtPersonnelPlanDto(BigDecimal count){
        this.count = count;
    }

    public PjtPersonnelPlanDto(String positionNm){
...
class PersonnelResult{
    ...
    List<PjtPersonnelPlanDto> saveList;
