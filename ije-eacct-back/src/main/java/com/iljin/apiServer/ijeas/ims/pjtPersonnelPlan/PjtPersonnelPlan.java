...
@Getter
@NoArgsConstructor
@IdClass(PjtPersonnelPlanKey.class)
@Table(name = "SPJMPM")
@Entity
public class PjtPersonnelPlan {
...
//    String d31;
    ...
    @Builder
    public PjtPersonnelPlan(String orgId, String projectMngNo, String degree, String periodYear, String periodMonth, String yyyyMm,
