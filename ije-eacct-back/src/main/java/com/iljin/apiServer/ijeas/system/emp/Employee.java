...
public class Employee {
    ...
    // HIT부서코드
    @Column(name = "HIT_DEPT_CD")
    private String hitDeptCd;

    // HIT부서명
    @Column(name = "HIT_DEPT_NM")
    private String hitDeptNm;
    ...
    // 보조계정코드
    @Column(name = "TR_ACCT_CD")
    private String trAcctCd;

    // 보조계정명
    @Column(name = "TR_ACCT_NM")
    ...
    private String slipTypeNm;

    // 회사구분코드(ERP)
    @Column(name = "SEGMENT1_CD")
    private String segment1Cd;

    // SEGMENT9_CD
    @Column(name = "SEGMENT9_CD")
    private String segment9Cd;

    // SEGMENT10_CD
    @Column(name = "SEGMENT10_CD")
    private String segment10Cd;
    ...
    // 부서권한여부
    @Column(name = "dept_role_yn")
    private String deptRoleYn;
