...
@Entity
@NoArgsConstructor
@Table(name = "TB_MST_CCTR_ERP")
@IdClass(CostCenterKey2.class)
public class CostCenter2 extends BaseEntity {
    ...
    @Builder
    public CostCenter2(String compCd, String deptCd, String deptNm, String startDateActive, String endDateActive, String enabledFlag, String attribute1
