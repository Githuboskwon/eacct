...
public class AuthorityController {
     ...
     * */
    @GetMapping("/user")
    public ResponseEntity<List<AuthorityDto>> getUserInfoByAuthority(@RequestParam String roleCd, @RequestParam String compCd, @RequestParam String value1,
                                                                     @RequestParam String value2) {
        List<AuthorityDto> list = authorityService.getUserInfoByAuthority(roleCd, compCd, value1, value2);
