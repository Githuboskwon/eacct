package com.iljin.apiServer.ijeas.ims.spjebm;
...
public class Spjebm {
    ...
    @Builder
    public Spjebm(String orgId, String projectMngNo, String periodYear, String periodMonth, String yyyyMm,
