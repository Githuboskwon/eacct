...
@Repository
public interface CostCenterRepository2 extends JpaRepository<CostCenter2, CostCenterKey2> {
...
//			" order by SORT ", nativeQuery=true)
	...
	List<CostCenter2> getByCctrCdOrCctrNmContaining(@Param("compCd") String compCd, @Param("value") String value);
