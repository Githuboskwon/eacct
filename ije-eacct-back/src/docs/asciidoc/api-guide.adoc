...
|/api/cctr2/{value}
|{deptCd \| deptNm} : 부서코드 OR 부서명
|===

Return : List<CostCenterDto2>
...
|/api/cctr/{value}
|{deptCd \| deptNm} : 부서코드/명
|===

Return : List<CostCenterDto>
...
|/api/project/list/{value}
|{projectCd \| projectNm} : 프로젝트코드/명
|===
